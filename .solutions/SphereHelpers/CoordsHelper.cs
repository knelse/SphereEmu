...
public static class CoordsHelper
{
    ...
    /// <summary>
    /// Client float at the current BitStream position: 23-bit fraction, 8-bit scale, 1-bit sign
    /// (same layout as <see cref="DecodeClientCoordinate"/> after the 6-bit shift into ping coords).
    /// </summary>
    public static double DecodeClientCoordinateFromBitStream(BitStream stream)
    {
