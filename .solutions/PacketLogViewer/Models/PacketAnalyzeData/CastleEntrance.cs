...
public class CastleEntrance : PacketAnalyzeData
{
    ...
    public override string DisplayValue =>
        $"{Id:X4} ({Enum.GetName(ObjectType) ?? string.Empty}) {Castle} at [{X:F2}, {Y:F2}, {Z:F2}]";

    public CastleEntrance(List<PacketPart> parts) : base(parts)
    {
        ...
        Castle = (Castles)(GetIntValue(PacketPartNames.CastleId) - 56);
    }
}