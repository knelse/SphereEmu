...
public static class CommonPackets
{
    ...
    public static byte[] CharacterSelectStartData(ushort playerIndex) => 
        new byte[] {0x52, 0x00, 0x2c, 0x01, 0x00, 0x00, 0x04, BitHelper.GetSecondByte(playerIndex), 
    ...
    public static byte[] CreateNewCharacterData(ushort playerIndex) => 
        new byte[] { 0x6c, 0x00, 0x2c, 0x01, 0x00, 0x00, 0x04, BitHelper.GetSecondByte(playerIndex),
        ...
        0xC8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0x00, 0x90, 0x01, 
        0x90, 0x01, 0x10, 0x00, 0x10, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 
    ...
    public static byte[] AccountOutdated(ushort playerIndex) => 
        new byte[] { 0x0e, 0x00, 0x2c, 0x01, 0x00, 0x00, 0x04, BitHelper.GetSecondByte(playerIndex),
    ...
    public static byte[] Echo(ushort playerIndex) => 
        new byte[] { 0x14, 0x00, 0x2c, 0x01, 0x00, 0x00, 0x04, BitHelper.GetSecondByte(playerIndex),
    ...
    public static byte[] SixSecondPing(ushort playerIndex) =>
        new byte[] { 0x13, 0x00, 0x2c, 0x01, 0x00, 0x00, 0x04, BitHelper.GetSecondByte(playerIndex),
    ...
    public static byte[] FifteenSecondPing(ushort playerIndex) =>
        new byte[] { 0x10, 0x00, 0x2c, 0x01, 0x00, 0x00, 0x04, BitHelper.GetSecondByte(playerIndex),
