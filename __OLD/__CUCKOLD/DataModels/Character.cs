...
public class Character
{
    ...
    [BsonRef("Clans")] public Clan? Clan { get; set; } = Clan.DefaultClan;
    ...
    public Character ()
    {
        ...
        Fists.Id = DbConnectionProvider.ItemCollection.Insert(Fists);
    }
    ...
    public byte[] ToCharacterListByteArray ()
    {
        ...
        var nameEncoded = SphereServer.Win1251!.GetBytes(Name);
    ...
    public byte[] ToGameDataByteArray ()
    {
        ...
        {
            var clanNameEncoded = SphereServer.Win1251.GetBytes(Clan!.Name);
    ...
    public byte[] GetTeleportByteArray (WorldCoords coords)
    {
        ...
        {
            0x1F, 0x00, 0x2C, 0x01, 0x00, 0x00, 0x04, MajorByte(ClientIndex), MinorByte(ClientIndex), 0x08, 0x40, 0xE3,
            0x01,
    ...
    public byte[] GetNewPlayerDungeonTeleportAndUpdateStatsByteArray (WorldCoords coords)
    {
        ...
        var tpBytes = new byte[]
        {
            0xAB, 0x00, 0x2C, 0x01, 0x00, 0x00, 0x04, MajorByte(ClientIndex), MinorByte(ClientIndex), 0x08, 0x40, 0xE3,
            0x01,
            (byte) x_1, (byte) x_2, (byte) x_3, (byte) x_4, (byte) y_1, (byte) y_2, (byte) y_3, (byte) y_4, (byte) z_1,
    ...
    public bool UpdateCurrentStats ()
    {
        ...
        foreach (var slot in slotsToUpdate)
        {
            ...
            var item = DbConnectionProvider.ItemCollection.FindById(Items[slot]);
