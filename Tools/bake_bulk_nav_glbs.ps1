...
# Default: production .res under GodotAssetSource/TerrainBake/GeneratedNavMeshes (no GLB).
...
param(
    ...
    [switch]$SkipPlan,
    [switch]$PlanOnly,
    # Write production GodotAssetSource/TerrainBake/GeneratedNavMeshes/*.res (default path; no GLB unless -ExportGlb).
    [switch]$WriteRes,
...
$navResDir = Join-Path $RepoRoot "GodotAssetSource\TerrainBake\GeneratedNavMeshes"
