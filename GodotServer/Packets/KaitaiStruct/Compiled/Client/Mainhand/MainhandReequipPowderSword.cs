...
namespace Kaitai
{
    public partial class MainhandReequipPowderSword : KaitaiStruct
    {
        public static MainhandReequipPowderSword FromFile(string fileName)
        {
            return new MainhandReequipPowderSword(new KaitaiStream(fileName));
        }
        ...
        public MainhandReequipPowderSword(KaitaiStream p__io, KaitaiStruct p__parent = null, MainhandReequipPowderSword p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class PacketLength : KaitaiStruct
        {
            ...
            public PacketLength(KaitaiStream p__io, MainhandReequipPowderSword.ClientHeader p__parent = null, MainhandReequipPowderSword p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MainhandReequipPowderSword m_root;
            private MainhandReequipPowderSword.ClientHeader m_parent;
            public ushort Length { get { return _length; } }
            public MainhandReequipPowderSword M_Root { get { return m_root; } }
            public MainhandReequipPowderSword.ClientHeader M_Parent { get { return m_parent; } }
        }
        public partial class ClientHeader : KaitaiStruct
        {
            ...
            public ClientHeader(KaitaiStream p__io, MainhandReequipPowderSword p__parent = null, MainhandReequipPowderSword p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MainhandReequipPowderSword m_root;
            private MainhandReequipPowderSword m_parent;
            ...
            public MainhandReequipPowderSword M_Root { get { return m_root; } }
            public MainhandReequipPowderSword M_Parent { get { return m_parent; } }
        }
        public partial class OkMarker : KaitaiStruct
        {
            ...
            public OkMarker(KaitaiStream p__io, MainhandReequipPowderSword.ClientHeader p__parent = null, MainhandReequipPowderSword p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
