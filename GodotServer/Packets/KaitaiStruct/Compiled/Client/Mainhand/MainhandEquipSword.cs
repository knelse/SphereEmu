...
namespace Kaitai
{
    public partial class MainhandEquipSword : KaitaiStruct
    {
        public static MainhandEquipSword FromFile(string fileName)
        {
            return new MainhandEquipSword(new KaitaiStream(fileName));
        }
        ...
        public MainhandEquipSword(KaitaiStream p__io, KaitaiStruct p__parent = null, MainhandEquipSword p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class PacketLength : KaitaiStruct
        {
            ...
            public PacketLength(KaitaiStream p__io, MainhandEquipSword.ClientHeader p__parent = null, MainhandEquipSword p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MainhandEquipSword m_root;
            private MainhandEquipSword.ClientHeader m_parent;
            public ushort Length { get { return _length; } }
            public MainhandEquipSword M_Root { get { return m_root; } }
            public MainhandEquipSword.ClientHeader M_Parent { get { return m_parent; } }
        }
        public partial class ClientHeader : KaitaiStruct
        {
            ...
            public ClientHeader(KaitaiStream p__io, MainhandEquipSword p__parent = null, MainhandEquipSword p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MainhandEquipSword m_root;
            private MainhandEquipSword m_parent;
            ...
            public MainhandEquipSword M_Root { get { return m_root; } }
            public MainhandEquipSword M_Parent { get { return m_parent; } }
        }
        public partial class OkMarker : KaitaiStruct
        {
            ...
            public OkMarker(KaitaiStream p__io, MainhandEquipSword.ClientHeader p__parent = null, MainhandEquipSword p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
