...
namespace Kaitai
{
    public partial class MainhandEquipPowder : KaitaiStruct
    {
        public static MainhandEquipPowder FromFile(string fileName)
        {
            return new MainhandEquipPowder(new KaitaiStream(fileName));
        }
        ...
        public MainhandEquipPowder(KaitaiStream p__io, KaitaiStruct p__parent = null, MainhandEquipPowder p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        private void _read()
        {
            ...
            _mainhandState = ((SlotState) m_io.ReadBitsIntLe(11));
        }
        public partial class PacketLength : KaitaiStruct
        {
            ...
            public PacketLength(KaitaiStream p__io, MainhandEquipPowder.ClientHeader p__parent = null, MainhandEquipPowder p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MainhandEquipPowder m_root;
            private MainhandEquipPowder.ClientHeader m_parent;
            public ushort Length { get { return _length; } }
            public MainhandEquipPowder M_Root { get { return m_root; } }
            public MainhandEquipPowder.ClientHeader M_Parent { get { return m_parent; } }
        }
        public partial class ClientHeader : KaitaiStruct
        {
            ...
            public ClientHeader(KaitaiStream p__io, MainhandEquipPowder p__parent = null, MainhandEquipPowder p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MainhandEquipPowder m_root;
            private MainhandEquipPowder m_parent;
            ...
            public MainhandEquipPowder M_Root { get { return m_root; } }
            public MainhandEquipPowder M_Parent { get { return m_parent; } }
        }
        public partial class OkMarker : KaitaiStruct
        {
            ...
            public OkMarker(KaitaiStream p__io, MainhandEquipPowder.ClientHeader p__parent = null, MainhandEquipPowder p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
