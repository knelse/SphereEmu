...
namespace SphServer.Packets
{
    ...
    public class ClientInitialData
    {
        ...
        {
            var firstCharData = Character1?.ToCharacterListByteArray() ??
                                CommonPackets.CreateNewCharacterData(playerIndex);
            var secondCharData = Character2?.ToCharacterListByteArray() ??
                                 CommonPackets.CreateNewCharacterData(playerIndex);
            var thirdCharData = Character3?.ToCharacterListByteArray() ??
                                CommonPackets.CreateNewCharacterData(playerIndex);
        ...
        public ClientInitialData(int playerId, CharacterData? char1 = null, CharacterData? char2 = null,
            CharacterData? char3 = null)
        {
            PlayerId = playerId;
            Character1 = char1;
            Character2 = char2;
