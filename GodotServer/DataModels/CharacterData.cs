...
namespace SphServer.DataModels
{
    ...
    public class CharacterData
    {
        ...
        public byte[] ToCharacterListByteArray()
        {
            ...
            var deg1 = (byte)(((DegreeLevelMinusOne & 0b111111) << 2) +
            ...
            var charDataBytes = new byte[]
            {
                ...
                BitHelper.GetFirstByte(PlayerIndex), 0x08, 0x40, 0x60, lookType, hpMax1, hpMax2, mpMax1, mpMax2, str1,
                str2,
                ...
                satCur2, hpCur1, hpCur2, mpCur1, mpCur2, titleStats1, titleStats2, degStats1, degStats2, degStats3,
                0xc0,
                ...
                bootsModelId, pantsModelId, armorModelId, helmetModelId, glovesModelId1, glovesModelId2, 0xc0, 0xc0,
                0x00, 0xfc, 0xff, 0xff, 0xff, isNotDeleted1,
                0x00, 0x00, 0x00, 0x00
            };
